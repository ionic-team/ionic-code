...
import { wtfLeave, wtfCreateScope, wtfStartTimeRange, wtfEndTimeRange } from 'angular2/angular2';
import { Ion } from '../ion';
...
export class NavController extends Ion {
    ...
    _beforeTrans(enteringView, leavingView, opts, done) {
        ...
        this._zone.runOutsideAngular(() => {
            ...
            let transAnimation = Animation.createTransition(enteringView, leavingView, opts);
